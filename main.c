...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, M1_PWM_EN_V_Pin|M1_PWM_EN_W_Pin|GPIO_PIN_0|M1_PWM_EN_U_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : M1_PWM_EN_V_Pin M1_PWM_EN_W_Pin M1_PWM_EN_U_Pin */
  GPIO_InitStruct.Pin = M1_PWM_EN_V_Pin|M1_PWM_EN_W_Pin|M1_PWM_EN_U_Pin;
